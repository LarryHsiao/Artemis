...
import com.silverhetch.artemis.media.AllVideo;
import com.silverhetch.artemis.media.Media;
import com.silverhetch.artemis.media.QueriedAudioList;
import com.silverhetch.artemis.media.QueriedVideoList;
...
public class MediaListActivity extends AuraActivity {
    private final MediaAdapter adapter = new MediaAdapter(media -> {
        Intent intent = new Intent(MediaListActivity.this, MediaPlayerService.class);
